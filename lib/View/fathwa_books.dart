...
class FathwaBooks extends StatefulWidget {
  const FathwaBooks({super.key});

  @override
  State<FathwaBooks> createState() => _FathwaBooksState();
}

class _FathwaBooksState extends State<FathwaBooks> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
backgroundColor: Colors.white,
        appBar: AppBar(
          title: Text("Fathwa Books",style: TextStyle(color: Colors.black),),
          backgroundColor: Colors.white,
          leading:  IconButton(
          ...
          builder: (context, item) {
            ...
            if (item.hasData) {
              ...
              final filtered = jsonMap?.keys
                  .where((path) => path.startsWith('assets/islamic_books/Urdu/Fathwa/'))
                  .toList();
