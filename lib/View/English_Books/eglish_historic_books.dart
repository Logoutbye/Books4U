...
class EnglishHistoricBooks extends StatefulWidget {
  const EnglishHistoricBooks({super.key});

  @override
  State<EnglishHistoricBooks> createState() => _EnglishHistoricBooksState();
}

class _EnglishHistoricBooksState extends State<EnglishHistoricBooks> {
  @override
              ...
              builder: (context, item) {
                ...
                if (item.hasData) {
                  ...
                  final filtered = jsonMap?.keys
                      .where((path) => path.startsWith('assets/islamic_books/English/historic_books/'))
                      .toList();
