...
class HistoricBooks extends StatefulWidget {
  const HistoricBooks({super.key});

  @override
  State<HistoricBooks> createState() => _HistoricBooksState();
}

class _HistoricBooksState extends State<HistoricBooks> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
backgroundColor: Colors.green,
        appBar: AppBar(
          title: Text("Historic Books"),
          backgroundColor: Colors.green,
        ),
          ...
          builder: (context, item) {
            ...
            if (item.hasData) {
              ...
              final filtered = jsonMap?.keys
                  .where((path) => path.startsWith('assets/islamic_books/historic_books/'))
                  .toList();
