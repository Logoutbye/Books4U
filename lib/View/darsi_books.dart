...
class DarsiBooks extends StatefulWidget {
  const DarsiBooks({super.key});

  @override
  State<DarsiBooks> createState() => _DarsiBooksState();
}

class _DarsiBooksState extends State<DarsiBooks> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
backgroundColor: Colors.white,
        appBar: AppBar(
          title: Text("Darsi Books",style: TextStyle(color: Colors.black)),
          backgroundColor: Colors.white,
          leading:  IconButton(
          ...
          builder: (context, item) {
            ...
            if (item.hasData) {
              ...
              final filtered = jsonMap?.keys
                  .where((path) => path.startsWith('assets/islamic_books/Urdu/Darsi/'))
                  .toList();
